    ...
    <div id="reportSection" className="p-4 md:p-6">
      <div className="bg-white rounded-xl shadow-md p-4 md:p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-6 overflow-x-auto pb-2">
          ...
          <button 
            onClick={() => {
              ...
              toast.info('กำลังโหลดข้อมูลสต๊อก...');
            }}
            className={`report-tab px-4 py-2.5 rounded-lg text-sm font-bold transition-all duration-200 whitespace-nowrap ${
        ...
        {activeReportTab === 'stock' && (
          <div className="report-content flex-1 overflow-y-auto">
            <div className="mb-6">
              <h3 className="text-lg font-bold text-gray-800">การวิเคราะห์ต้นทุนและกำไร</h3>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-5 border border-gray-200">
                <h4 className="font-bold text-gray-800 mb-4">เมนูที่มีกำไรสูงสุด</h4>
                <div className="space-y-3">
              ...
              <div className="bg-white rounded-xl p-5 border border-gray-200">
                <h4 className="font-bold text-gray-800 mb-4">เมนูที่มีกำไรต่ำ (&lt; 30%)</h4>
                <div className="space-y-3">
                  <div className="text-center py-8">
                    <div className="text-gray-400 mb-2">
                      <svg className="w-12 h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-6 bg-white rounded-xl p-5 border border-gray-200">
              <h4 className="font-bold text-gray-800 mb-4">รายละเอียดต้นทุนเมนู</h4>
              <div className="overflow-x-auto">
                <table className="min-w-full bg-white rounded-lg overflow-hidden">
                  <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                    <tr>
                      <th className="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">เมนู</th>
                      <th className="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">ราคาขาย</th>
                      <th className="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">ต้นทุน</th>
                      <th className="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">กำไร</th>
                      <th className="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">% กำไร</th>
                      <th className="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">ขายได้</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
                    <tr>
